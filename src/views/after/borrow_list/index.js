...
const list1 = ['全部','待处理','全部待还','未逾期待还','已逾期待还','已完结','有争议',<span className='select-more'>自定义 <img src='imgs/com/arrows.svg' /></span>]
...
export default class Page extends Component {
    ...
    getPageInfo=(more)=>{
        ...
        $.ajaxE({
            ...
            url: '/loanlater/loaninfo/getBorrowAccount',
            data: pageInfo
        }).then((data) => {
