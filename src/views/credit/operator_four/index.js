                ...
                switch (json.status) {
                            ...
                            { 
                                text: '跳过运营商认证', onPress: () => {
                                    $.ajaxE( {
                                        ...
                                        data: {
                                            telephone: _this.state.creditPhoneNo
                                        },
                                    }).then((json) => {
                                        _this.props.history.push({
                                            pathname: "/credit",
                    ...
                    case 2503:{
                        ...
                        _this.props.history.push({
                            ...
                            query: {
                                creditPhoneNo: _this.state.creditPhoneNo,
                                typeCode: 0,
                            }
                        });
                        break;
            ...
            <div className='view-credit-all'>
                <div style={{height: '100%',overflow:'auto',paddingBottom: '0.2rem'}}>
                    ...
                    <Flex className="single">
                        ...
                        <span className="form-font">短信验证码</span>
                        <span className="form-text">已向{creditPhoneNo?creditPhoneNo.slice(7,11):null}的手机发送验证码</span>
                    </Flex>
