        ...
        return (
            <div className="view-login" ref={ref=>this.scrollBox = ref}>
                <div className="view-con">
                    <div className="hello size22">请填写您身份证号码</div>
                    ...
                    <List className="list">
                        <InputItem
                            ...
                            clear
                            onFocus = {$.clearErrors.bind(this,'idnum')}
                            {...getFieldProps('idnum', {
                                rules: [{ required: true, message: '请填写您身份证号码' }],
                                validateTrigger:'onBlur'
                            })}>
                        </InputItem>
                        <div className='common-jc-error'>{getFieldError('idnum') && getFieldError('idnum').join(',')}</div>
                    </List>
